    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-32">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-300">
          <Button onClick={scrollToEvents} variant="hero" size="lg">
            See Events
          </Button>
        </div>

        {/* Stats */}
        <div className="grid grid-cols-2 gap-8 mt-16 max-w-xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-500">
